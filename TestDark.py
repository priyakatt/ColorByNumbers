...
#Red
light_red = np.array([0,60,75])
dark_red = np.array([9,255,255])
#orange
light_orange = np.array([10,60,75])
dark_orange = np.array([20,255,255])
#Y
light_Y=np.array([21,60,75])
dark_Y=np.array([30,255,255])
#G1
light_G1 = np.array([31,60,75])
dark_G1 = np.array([47,255,255])
#G2
light_G2 = np.array([48,60,75])
dark_G2 = np.array([64,255,255])
#G3
light_G3 = np.array([65,60,75])
dark_G3 = np.array([80,255,255])
#B1
light_B1 = np.array([81,60,75])
dark_B1 = np.array([94,255,255])
#B2
light_B2 =np.array([95,60,75])
dark_B2 = np.array([108,255,255])
#B3
light_B3 = np.array([109,60,75])
dark_B3 =np.array([122,255,255])
#Purple
light_Purple = np.array([123,60,75])
dark_Purple = np.array([140,255,255])
#Purp/Pink
light_PurpPink = np.array([141,60,75])
dark_PurpPink = np.array([150,255,255])
#Pink/Red
light_PinkRed = np.array([151,60,75])
